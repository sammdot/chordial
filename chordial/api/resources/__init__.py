...
from chordial.api.resources.dictionary import DictionaryResource, DictionariesResource
...
from chordial.api.resources.user import UserResource, UsersResource
