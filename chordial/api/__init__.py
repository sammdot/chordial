...
api.add_resource(AnalysisResource, "/analysis")
api.add_resource(
  DictionaryEntriesResource,
  "/dicts/<uid6:dict_id>/entries",
  endpoint="dict_entries",
)
...
api.add_resource(
  EntryByIdsResource, "/entries/<uid8:outline_id>/<uid8:translation_id>"
)
...
api.add_resource(
  OutlineResource, "/outlines/<uid8:outline_id>", endpoint="outline"
)
api.add_resource(
  TheoryResource, "/theories/<uid4:theory_id>", endpoint="theory"
)
api.add_resource(TheoriesResource, "/theories")
api.add_resource(
  TranslationResource,
  "/translations/<uid8:translation_id>",
